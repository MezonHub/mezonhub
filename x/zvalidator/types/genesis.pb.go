...
// source: zvalidator/genesis.proto
...
func (m *GenesisState) GetSelectedZValidatorList() []*ZValidator {
	if m != nil {
		return m.SelectedZValidatorList
	}
	return nil
}
...
func (m *GenesisState) GetDealingZValidatorList() []*DealingZValidator {
	if m != nil {
		return m.DealingZValidatorList
	}
	return nil
}
...
func (m *ZValidator) Reset()         { *m = ZValidator{} }
func (m *ZValidator) String() string { return proto.CompactTextString(m) }
...
func (m *ZValidator) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ZValidator.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ZValidator) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ZValidator.Merge(m, src)
}
func (m *ZValidator) XXX_Size() int {
	return m.Size()
}
func (m *ZValidator) XXX_DiscardUnknown() {
	xxx_messageInfo_ZValidator.DiscardUnknown(m)
}

var xxx_messageInfo_ZValidator proto.InternalMessageInfo
...
func (m *DealingZValidator) Reset()         { *m = DealingZValidator{} }
func (m *DealingZValidator) String() string { return proto.CompactTextString(m) }
...
func (m *DealingZValidator) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DealingZValidator.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DealingZValidator) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DealingZValidator.Merge(m, src)
}
func (m *DealingZValidator) XXX_Size() int {
	return m.Size()
}
func (m *DealingZValidator) XXX_DiscardUnknown() {
	xxx_messageInfo_DealingZValidator.DiscardUnknown(m)
}

var xxx_messageInfo_DealingZValidator proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "mezonhub.mezonhub.zvalidator.GenesisState")
	proto.RegisterType((*ZValidator)(nil), "mezonhub.mezonhub.zvalidator.ZValidator")
	proto.RegisterType((*DealingZValidator)(nil), "mezonhub.mezonhub.zvalidator.DealingZValidator")
	proto.RegisterType((*Cycle)(nil), "mezonhub.mezonhub.zvalidator.Cycle")
	proto.RegisterType((*CycleSeconds)(nil), "mezonhub.mezonhub.zvalidator.CycleSeconds")
	proto.RegisterType((*ShuffleSeconds)(nil), "mezonhub.mezonhub.zvalidator.ShuffleSeconds")
}

func init() { proto.RegisterFile("zvalidator/genesis.proto", fileDescriptor_ab550827adf3778b) }
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DealingZValidatorList) > 0 {
		for iNdEx := len(m.DealingZValidatorList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DealingZValidatorList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.SelectedZValidatorList) > 0 {
		for iNdEx := len(m.SelectedZValidatorList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SelectedZValidatorList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.SelectedZValidatorList) > 0 {
		for _, e := range m.SelectedZValidatorList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
	...
	if len(m.DealingZValidatorList) > 0 {
		for _, e := range m.DealingZValidatorList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelectedZValidatorList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SelectedZValidatorList = append(m.SelectedZValidatorList, &ZValidator{})
			if err := m.SelectedZValidatorList[len(m.SelectedZValidatorList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DealingZValidatorList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DealingZValidatorList = append(m.DealingZValidatorList, &DealingZValidator{})
			if err := m.DealingZValidatorList[len(m.DealingZValidatorList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ZValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ZValidator: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ZValidator: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DealingZValidator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DealingZValidator: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DealingZValidator: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
