...
func TestMsgLiquidityUnbond_GetSignBytes(t *testing.T) {
	addr, _ := sdk.AccAddressFromBech32("mezon1wz9ax9xlxjtw9akxyf29aflau4f63p5duvkg9z")
	...
	t.Log(string(res))
	expected := `{"type":"ledger/LiquidityUnbond","value":{"creator":"mezon1wz9ax9xlxjtw9akxyf29aflau4f63p5duvkg9z","pool":"cosmos1gsth46z50w256p4kq36xquh4q90mfjq0t4lm9scln6zucg64epyqudzqzm","recipient":"cosmos1wz9ax9xlxjtw9akxyf29aflau4f63p5d88xz36","value":{"amount":"200000","denom":"uratom"}}}`
