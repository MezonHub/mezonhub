...
type GenesisInterchainTxProposalInfo struct {
	...
	Status        InterchainTxStatus `protobuf:"varint,5,opt,name=status,proto3,enum=mezonhub.mezonhub.ledger.InterchainTxStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "mezonhub.mezonhub.ledger.GenesisState")
	proto.RegisterType((*UnbondSwitch)(nil), "mezonhub.mezonhub.ledger.UnbondSwitch")
	proto.RegisterType((*GenesisEraSnapshot)(nil), "mezonhub.mezonhub.ledger.GenesisEraSnapshot")
	proto.RegisterType((*StakingRewardCommission)(nil), "mezonhub.mezonhub.ledger.StakingRewardCommission")
	proto.RegisterType((*UnbondCommission)(nil), "mezonhub.mezonhub.ledger.UnbondCommission")
	proto.RegisterType((*RelayFeeReceiver)(nil), "mezonhub.mezonhub.ledger.RelayFeeReceiver")
	proto.RegisterType((*TotalExpectedActive)(nil), "mezonhub.mezonhub.ledger.TotalExpectedActive")
	proto.RegisterType((*TotalExpectedFee)(nil), "mezonhub.mezonhub.ledger.TotalExpectedFee")
	proto.RegisterType((*GenesisPoolUnbonding)(nil), "mezonhub.mezonhub.ledger.GenesisPoolUnbonding")
	proto.RegisterType((*GenesisSnapshot)(nil), "mezonhub.mezonhub.ledger.GenesisSnapshot")
	proto.RegisterType((*GenesisInterchainTxProposalInfo)(nil), "mezonhub.mezonhub.ledger.GenesisInterchainTxProposalInfo")
}
