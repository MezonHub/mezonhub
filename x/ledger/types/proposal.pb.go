...
type BondReportProposal struct {
	...
	Action   BondAction `protobuf:"varint,4,opt,name=action,proto3,enum=mezonhub.mezonhub.ledger.BondAction" json:"action,omitempty"`
...
type ExecuteBondProposal struct {
	...
	State    LiquidityBondState                     `protobuf:"varint,8,opt,name=state,proto3,enum=mezonhub.mezonhub.ledger.LiquidityBondState" json:"state,omitempty"`
}
...
func init() {
	proto.RegisterType((*SetChainEraProposal)(nil), "mezonhub.mezonhub.ledger.SetChainEraProposal")
	proto.RegisterType((*BondReportProposal)(nil), "mezonhub.mezonhub.ledger.BondReportProposal")
	proto.RegisterType((*ActiveReportProposal)(nil), "mezonhub.mezonhub.ledger.ActiveReportProposal")
	proto.RegisterType((*TransferReportProposal)(nil), "mezonhub.mezonhub.ledger.TransferReportProposal")
	proto.RegisterType((*ExecuteBondProposal)(nil), "mezonhub.mezonhub.ledger.ExecuteBondProposal")
	proto.RegisterType((*InterchainTxProposal)(nil), "mezonhub.mezonhub.ledger.InterchainTxProposal")
}
