...
type PoolDetail struct {
	...
	Status      PoolStatus `protobuf:"varint,5,opt,name=status,proto3,enum=mezonhub.mezonhub.ledger.PoolStatus" json:"status,omitempty"`
}
...
type BondSnapshot struct {
	...
	BondState PoolBondState `protobuf:"varint,6,opt,name=bond_state,json=bondState,proto3,enum=mezonhub.mezonhub.ledger.PoolBondState" json:"bond_state,omitempty"`
}
...
type ExchangeRate struct {
	Denom string                                 `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	Value github_com_mezonhub_mezonhub_utils.Dec `protobuf:"bytes,2,opt,name=value,proto3,customtype=github.com/mezonhub/mezonhub/utils.Dec" json:"value"`
}
...
type EraExchangeRate struct {
	Denom string                                 `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	Era   uint32                                 `protobuf:"varint,2,opt,name=era,proto3" json:"era,omitempty"`
	Value github_com_mezonhub_mezonhub_utils.Dec `protobuf:"bytes,3,opt,name=value,proto3,customtype=github.com/mezonhub/mezonhub/utils.Dec" json:"value"`
}
...
type BondRecord struct {
	...
	State  LiquidityBondState                     `protobuf:"varint,6,opt,name=state,proto3,enum=mezonhub.mezonhub.ledger.LiquidityBondState" json:"state,omitempty"`
}
...
type IcaPoolDetail struct {
	...
	Status            IcaPoolStatus `protobuf:"varint,3,opt,name=status,proto3,enum=mezonhub.mezonhub.ledger.IcaPoolStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("mezonhub.mezonhub.ledger.PoolStatus", PoolStatus_name, PoolStatus_value)
	proto.RegisterEnum("mezonhub.mezonhub.ledger.PoolBondState", PoolBondState_name, PoolBondState_value)
	proto.RegisterEnum("mezonhub.mezonhub.ledger.BondAction", BondAction_name, BondAction_value)
	proto.RegisterEnum("mezonhub.mezonhub.ledger.LiquidityBondState", LiquidityBondState_name, LiquidityBondState_value)
	proto.RegisterEnum("mezonhub.mezonhub.ledger.OriginalTxType", OriginalTxType_name, OriginalTxType_value)
	proto.RegisterEnum("mezonhub.mezonhub.ledger.IcaPoolStatus", IcaPoolStatus_name, IcaPoolStatus_value)
	proto.RegisterEnum("mezonhub.mezonhub.ledger.InterchainTxStatus", InterchainTxStatus_name, InterchainTxStatus_value)
	proto.RegisterType((*ChainEra)(nil), "mezonhub.mezonhub.ledger.ChainEra")
	proto.RegisterType((*Pool)(nil), "mezonhub.mezonhub.ledger.Pool")
	proto.RegisterType((*BondPipeline)(nil), "mezonhub.mezonhub.ledger.BondPipeline")
	proto.RegisterType((*EraSnapshot)(nil), "mezonhub.mezonhub.ledger.EraSnapshot")
	proto.RegisterType((*EraUnbondLimit)(nil), "mezonhub.mezonhub.ledger.EraUnbondLimit")
	proto.RegisterType((*PoolDetail)(nil), "mezonhub.mezonhub.ledger.PoolDetail")
	proto.RegisterType((*LinkChunk)(nil), "mezonhub.mezonhub.ledger.LinkChunk")
	proto.RegisterType((*BondSnapshot)(nil), "mezonhub.mezonhub.ledger.BondSnapshot")
	proto.RegisterType((*ExchangeRate)(nil), "mezonhub.mezonhub.ledger.ExchangeRate")
	proto.RegisterType((*TotalProtocolFee)(nil), "mezonhub.mezonhub.ledger.TotalProtocolFee")
	proto.RegisterType((*EraExchangeRate)(nil), "mezonhub.mezonhub.ledger.EraExchangeRate")
	proto.RegisterType((*UnbondRelayFee)(nil), "mezonhub.mezonhub.ledger.UnbondRelayFee")
	proto.RegisterType((*Unbonding)(nil), "mezonhub.mezonhub.ledger.Unbonding")
	proto.RegisterType((*BondRecord)(nil), "mezonhub.mezonhub.ledger.BondRecord")
	proto.RegisterType((*Signature)(nil), "mezonhub.mezonhub.ledger.Signature")
	proto.RegisterType((*RParams)(nil), "mezonhub.mezonhub.ledger.RParams")
	proto.RegisterType((*IcaAccount)(nil), "mezonhub.mezonhub.ledger.IcaAccount")
	proto.RegisterType((*IcaPoolDetail)(nil), "mezonhub.mezonhub.ledger.IcaPoolDetail")
}
