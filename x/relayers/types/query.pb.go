...
func init() {
	proto.RegisterType((*QueryRelayersRequest)(nil), "mezonhub.mezonhub.relayers.QueryRelayersRequest")
	proto.RegisterType((*QueryRelayersResponse)(nil), "mezonhub.mezonhub.relayers.QueryRelayersResponse")
	proto.RegisterType((*QueryThresholdRequest)(nil), "mezonhub.mezonhub.relayers.QueryThresholdRequest")
	proto.RegisterType((*QueryThresholdResponse)(nil), "mezonhub.mezonhub.relayers.QueryThresholdResponse")
}
...
func (c *queryClient) Relayers(ctx context.Context, in *QueryRelayersRequest, opts ...grpc.CallOption) (*QueryRelayersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.relayers.Query/Relayers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Threshold(ctx context.Context, in *QueryThresholdRequest, opts ...grpc.CallOption) (*QueryThresholdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.relayers.Query/Threshold", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Relayers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.relayers.Query/Relayers",
	}
...
func _Query_Threshold_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.relayers.Query/Threshold",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.relayers.Query",
