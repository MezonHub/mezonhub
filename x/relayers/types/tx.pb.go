...
func init() {
	proto.RegisterType((*MsgAddRelayer)(nil), "mezonhub.mezonhub.relayers.MsgAddRelayer")
	proto.RegisterType((*MsgAddRelayerResponse)(nil), "mezonhub.mezonhub.relayers.MsgAddRelayerResponse")
	proto.RegisterType((*MsgDeleteRelayer)(nil), "mezonhub.mezonhub.relayers.MsgDeleteRelayer")
	proto.RegisterType((*MsgDeleteRelayerResponse)(nil), "mezonhub.mezonhub.relayers.MsgDeleteRelayerResponse")
	proto.RegisterType((*MsgSetThreshold)(nil), "mezonhub.mezonhub.relayers.MsgSetThreshold")
	proto.RegisterType((*MsgSetThresholdResponse)(nil), "mezonhub.mezonhub.relayers.MsgSetThresholdResponse")
}
...
func (c *msgClient) AddRelayer(ctx context.Context, in *MsgAddRelayer, opts ...grpc.CallOption) (*MsgAddRelayerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.relayers.Msg/AddRelayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteRelayer(ctx context.Context, in *MsgDeleteRelayer, opts ...grpc.CallOption) (*MsgDeleteRelayerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.relayers.Msg/DeleteRelayer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetThreshold(ctx context.Context, in *MsgSetThreshold, opts ...grpc.CallOption) (*MsgSetThresholdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.relayers.Msg/SetThreshold", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddRelayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.relayers.Msg/AddRelayer",
	}
...
func _Msg_DeleteRelayer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.relayers.Msg/DeleteRelayer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetThreshold_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.relayers.Msg/SetThreshold",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.relayers.Msg",
