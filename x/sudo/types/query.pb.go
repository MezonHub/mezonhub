...
func init() {
	proto.RegisterType((*QueryAdminRequest)(nil), "mezonhub.mezonhub.sudo.QueryAdminRequest")
	proto.RegisterType((*QueryAdminResponse)(nil), "mezonhub.mezonhub.sudo.QueryAdminResponse")
}
...
func (c *queryClient) Admin(ctx context.Context, in *QueryAdminRequest, opts ...grpc.CallOption) (*QueryAdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.sudo.Query/Admin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Admin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.sudo.Query/Admin",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.sudo.Query",
