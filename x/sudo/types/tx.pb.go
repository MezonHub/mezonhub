...
func init() {
	proto.RegisterType((*MsgUpdateAdmin)(nil), "mezonhub.mezonhub.sudo.MsgUpdateAdmin")
	proto.RegisterType((*MsgUpdateAdminResponse)(nil), "mezonhub.mezonhub.sudo.MsgUpdateAdminResponse")
}
...
func (c *msgClient) UpdateAdmin(ctx context.Context, in *MsgUpdateAdmin, opts ...grpc.CallOption) (*MsgUpdateAdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.sudo.Msg/UpdateAdmin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.sudo.Msg/UpdateAdmin",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.sudo.Msg",
