...
type MsgSubmitProposalResponse struct {
	...
	Status ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=mezonhub.mezonhub.rvote.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgSetProposalLife)(nil), "mezonhub.mezonhub.rvote.MsgSetProposalLife")
	proto.RegisterType((*MsgSetProposalLifeResponse)(nil), "mezonhub.mezonhub.rvote.MsgSetProposalLifeResponse")
	proto.RegisterType((*MsgSubmitProposal)(nil), "mezonhub.mezonhub.rvote.MsgSubmitProposal")
	proto.RegisterType((*MsgSubmitProposalResponse)(nil), "mezonhub.mezonhub.rvote.MsgSubmitProposalResponse")
}
...
func (c *msgClient) SetProposalLife(ctx context.Context, in *MsgSetProposalLife, opts ...grpc.CallOption) (*MsgSetProposalLifeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.rvote.Msg/SetProposalLife", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SubmitProposal(ctx context.Context, in *MsgSubmitProposal, opts ...grpc.CallOption) (*MsgSubmitProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.rvote.Msg/SubmitProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetProposalLife_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.rvote.Msg/SetProposalLife",
	}
...
func _Msg_SubmitProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.rvote.Msg/SubmitProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.rvote.Msg",
