...
type Proposal struct {
	...
	Status      ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=mezonhub.mezonhub.rvote.ProposalStatus" json:"status,omitempty" yaml:"prop_status"`
...
func init() {
	proto.RegisterEnum("mezonhub.mezonhub.rvote.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*Proposal)(nil), "mezonhub.mezonhub.rvote.Proposal")
}
