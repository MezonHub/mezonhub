...
func init() {
	proto.RegisterType((*MsgSetMerkleRoot)(nil), "mezonhub.mezonhub.claim.MsgSetMerkleRoot")
	proto.RegisterType((*MsgSetMerkleRootResponse)(nil), "mezonhub.mezonhub.claim.MsgSetMerkleRootResponse")
	proto.RegisterType((*MsgClaim)(nil), "mezonhub.mezonhub.claim.MsgClaim")
	proto.RegisterType((*MsgClaimResponse)(nil), "mezonhub.mezonhub.claim.MsgClaimResponse")
	proto.RegisterType((*MsgToggleClaimSwitch)(nil), "mezonhub.mezonhub.claim.MsgToggleClaimSwitch")
	proto.RegisterType((*MsgToggleClaimSwitchResponse)(nil), "mezonhub.mezonhub.claim.MsgToggleClaimSwitchResponse")
	proto.RegisterType((*MsgProvideToken)(nil), "mezonhub.mezonhub.claim.MsgProvideToken")
	proto.RegisterType((*MsgProvideTokenResponse)(nil), "mezonhub.mezonhub.claim.MsgProvideTokenResponse")
	proto.RegisterType((*MsgWithdrawToken)(nil), "mezonhub.mezonhub.claim.MsgWithdrawToken")
	proto.RegisterType((*MsgWithdrawTokenResponse)(nil), "mezonhub.mezonhub.claim.MsgWithdrawTokenResponse")
}
...
func (c *msgClient) SetMerkleRoot(ctx context.Context, in *MsgSetMerkleRoot, opts ...grpc.CallOption) (*MsgSetMerkleRootResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Msg/SetMerkleRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Claim(ctx context.Context, in *MsgClaim, opts ...grpc.CallOption) (*MsgClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Msg/Claim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ToggleClaimSwitch(ctx context.Context, in *MsgToggleClaimSwitch, opts ...grpc.CallOption) (*MsgToggleClaimSwitchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Msg/ToggleClaimSwitch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ProvideToken(ctx context.Context, in *MsgProvideToken, opts ...grpc.CallOption) (*MsgProvideTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Msg/ProvideToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WithdrawToken(ctx context.Context, in *MsgWithdrawToken, opts ...grpc.CallOption) (*MsgWithdrawTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Msg/WithdrawToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetMerkleRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Msg/SetMerkleRoot",
	}
...
func _Msg_Claim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Msg/Claim",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ToggleClaimSwitch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Msg/ToggleClaimSwitch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ProvideToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Msg/ProvideToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_WithdrawToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Msg/WithdrawToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.claim.Msg",
