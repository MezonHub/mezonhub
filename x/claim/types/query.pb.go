...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "mezonhub.mezonhub.claim.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "mezonhub.mezonhub.claim.QueryParamsResponse")
	proto.RegisterType((*QueryIsClaimedRequest)(nil), "mezonhub.mezonhub.claim.QueryIsClaimedRequest")
	proto.RegisterType((*QueryIsClaimedResponse)(nil), "mezonhub.mezonhub.claim.QueryIsClaimedResponse")
	proto.RegisterType((*QueryClaimSwitchRequest)(nil), "mezonhub.mezonhub.claim.QueryClaimSwitchRequest")
	proto.RegisterType((*QueryClaimSwitchResponse)(nil), "mezonhub.mezonhub.claim.QueryClaimSwitchResponse")
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) IsClaimed(ctx context.Context, in *QueryIsClaimedRequest, opts ...grpc.CallOption) (*QueryIsClaimedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Query/IsClaimed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimSwitch(ctx context.Context, in *QueryClaimSwitchRequest, opts ...grpc.CallOption) (*QueryClaimSwitchResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.claim.Query/ClaimSwitch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Query/Params",
	}
...
func _Query_IsClaimed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Query/IsClaimed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimSwitch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.claim.Query/ClaimSwitch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.claim.Query",
