...
func init() {
	proto.RegisterType((*SwapPool)(nil), "mezonhub.mezonhub.zdex.SwapPool")
}

func init() { proto.RegisterFile("zdex/models.proto", fileDescriptor_cc88587beb583d4f) }
