...
func init() {
	proto.RegisterType((*MsgAddMintRewardAct)(nil), "mezonhub.mezonhub.zmintreward.MsgAddMintRewardAct")
	proto.RegisterType((*MsgAddMintRewardActResponse)(nil), "mezonhub.mezonhub.zmintreward.MsgAddMintRewardActResponse")
	proto.RegisterType((*MsgUpdateMintRewardAct)(nil), "mezonhub.mezonhub.zmintreward.MsgUpdateMintRewardAct")
	proto.RegisterType((*MsgUpdateMintRewardActResponse)(nil), "mezonhub.mezonhub.zmintreward.MsgUpdateMintRewardActResponse")
	proto.RegisterType((*MsgClaimMintReward)(nil), "mezonhub.mezonhub.zmintreward.MsgClaimMintReward")
	proto.RegisterType((*MsgClaimMintRewardResponse)(nil), "mezonhub.mezonhub.zmintreward.MsgClaimMintRewardResponse")
	proto.RegisterType((*MsgProvideRewardToken)(nil), "mezonhub.mezonhub.zmintreward.MsgProvideRewardToken")
	proto.RegisterType((*MsgProvideRewardTokenResponse)(nil), "mezonhub.mezonhub.zmintreward.MsgProvideRewardTokenResponse")
}

func init() { proto.RegisterFile("zmintreward/tx.proto", fileDescriptor_8dd96f257662b770) }
...
func (c *msgClient) AddMintRewardAct(ctx context.Context, in *MsgAddMintRewardAct, opts ...grpc.CallOption) (*MsgAddMintRewardActResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zmintreward.Msg/AddMintRewardAct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateMintRewardAct(ctx context.Context, in *MsgUpdateMintRewardAct, opts ...grpc.CallOption) (*MsgUpdateMintRewardActResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zmintreward.Msg/UpdateMintRewardAct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimMintReward(ctx context.Context, in *MsgClaimMintReward, opts ...grpc.CallOption) (*MsgClaimMintRewardResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zmintreward.Msg/ClaimMintReward", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ProvideRewardToken(ctx context.Context, in *MsgProvideRewardToken, opts ...grpc.CallOption) (*MsgProvideRewardTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zmintreward.Msg/ProvideRewardToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddMintRewardAct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zmintreward.Msg/AddMintRewardAct",
	}
...
func _Msg_UpdateMintRewardAct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zmintreward.Msg/UpdateMintRewardAct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClaimMintReward_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zmintreward.Msg/ClaimMintReward",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ProvideRewardToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zmintreward.Msg/ProvideRewardToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.zmintreward.Msg",
