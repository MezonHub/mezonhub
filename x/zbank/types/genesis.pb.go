...
func init() {
	proto.RegisterType((*GenesisState)(nil), "mezonhub.mezonhub.zbank.GenesisState")
	proto.RegisterType((*AddressPrefix)(nil), "mezonhub.mezonhub.zbank.AddressPrefix")
}

func init() { proto.RegisterFile("zbank/genesis.proto", fileDescriptor_fd1f8a6f057161fb) }
