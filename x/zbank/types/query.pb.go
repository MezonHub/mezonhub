...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "mezonhub.mezonhub.zbank.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "mezonhub.mezonhub.zbank.QueryParamsResponse")
	proto.RegisterType((*QueryAddressPrefixRequest)(nil), "mezonhub.mezonhub.zbank.QueryAddressPrefixRequest")
	proto.RegisterType((*QueryAddressPrefixResponse)(nil), "mezonhub.mezonhub.zbank.QueryAddressPrefixResponse")
}

func init() { proto.RegisterFile("zbank/query.proto", fileDescriptor_0cb13210cbef7429) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zbank.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AddressPrefix(ctx context.Context, in *QueryAddressPrefixRequest, opts ...grpc.CallOption) (*QueryAddressPrefixResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zbank.Query/AddressPrefix", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zbank.Query/Params",
	}
...
func _Query_AddressPrefix_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zbank.Query/AddressPrefix",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.zbank.Query",
