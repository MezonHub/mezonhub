...
func init() {
	proto.RegisterType((*MsgAddDenom)(nil), "mezonhub.mezonhub.zbank.MsgAddDenom")
	proto.RegisterType((*MsgAddDenomResponse)(nil), "mezonhub.mezonhub.zbank.MsgAddDenomResponse")
}

func init() { proto.RegisterFile("zbank/tx.proto", fileDescriptor_c7b27080a32af813) }
...
func (c *msgClient) AddDenom(ctx context.Context, in *MsgAddDenom, opts ...grpc.CallOption) (*MsgAddDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zbank.Msg/AddDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zbank.Msg/AddDenom",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.zbank.Msg",
