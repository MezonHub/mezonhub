...
import (
	...
	zvalidatortypes "github.com/mezonhub/mezonhub/x/zvalidator/types"
...
func (k msgServer) SubmitProposal(goCtx context.Context, msg *types.MsgSubmitProposal) (*types.MsgSubmitProposalResponse, error) {
	...
	if content.ProposalRoute() == zvalidatortypes.ModuleName && content.ProposalType() == zvalidatortypes.TypeUpdateZValidatorReportProposal {
