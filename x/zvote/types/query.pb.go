...
func init() {
	proto.RegisterType((*QueryGetProposalRequest)(nil), "mezonhub.mezonhub.zvote.QueryGetProposalRequest")
	proto.RegisterType((*QueryGetProposalResponse)(nil), "mezonhub.mezonhub.zvote.QueryGetProposalResponse")
	proto.RegisterType((*QueryGetProposalLifeRequest)(nil), "mezonhub.mezonhub.zvote.QueryGetProposalLifeRequest")
	proto.RegisterType((*QueryGetProposalLifeResponse)(nil), "mezonhub.mezonhub.zvote.QueryGetProposalLifeResponse")
}

func init() { proto.RegisterFile("zvote/query.proto", fileDescriptor_fe9488996c0b15b7) }
...
func (c *queryClient) GetProposal(ctx context.Context, in *QueryGetProposalRequest, opts ...grpc.CallOption) (*QueryGetProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zvote.Query/GetProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetProposalLife(ctx context.Context, in *QueryGetProposalLifeRequest, opts ...grpc.CallOption) (*QueryGetProposalLifeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zvote.Query/GetProposalLife", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_GetProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zvote.Query/GetProposal",
	}
...
func _Query_GetProposalLife_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zvote.Query/GetProposalLife",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.zvote.Query",
