...
type MsgSubmitProposalResponse struct {
	...
	Status ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=mezonhub.mezonhub.zvote.ProposalStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgSetProposalLife)(nil), "mezonhub.mezonhub.zvote.MsgSetProposalLife")
	proto.RegisterType((*MsgSetProposalLifeResponse)(nil), "mezonhub.mezonhub.zvote.MsgSetProposalLifeResponse")
	proto.RegisterType((*MsgSubmitProposal)(nil), "mezonhub.mezonhub.zvote.MsgSubmitProposal")
	proto.RegisterType((*MsgSubmitProposalResponse)(nil), "mezonhub.mezonhub.zvote.MsgSubmitProposalResponse")
}

func init() { proto.RegisterFile("zvote/tx.proto", fileDescriptor_a2fc698fa4472001) }
...
func (c *msgClient) SetProposalLife(ctx context.Context, in *MsgSetProposalLife, opts ...grpc.CallOption) (*MsgSetProposalLifeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zvote.Msg/SetProposalLife", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SubmitProposal(ctx context.Context, in *MsgSubmitProposal, opts ...grpc.CallOption) (*MsgSubmitProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mezonhub.mezonhub.zvote.Msg/SubmitProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetProposalLife_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zvote.Msg/SetProposalLife",
	}
...
func _Msg_SubmitProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mezonhub.mezonhub.zvote.Msg/SubmitProposal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mezonhub.mezonhub.zvote.Msg",
