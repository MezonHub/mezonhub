...
type Proposal struct {
	...
	Status      ProposalStatus `protobuf:"varint,2,opt,name=status,proto3,enum=mezonhub.mezonhub.zvote.ProposalStatus" json:"status,omitempty" yaml:"prop_status"`
...
func init() {
	proto.RegisterEnum("mezonhub.mezonhub.zvote.ProposalStatus", ProposalStatus_name, ProposalStatus_value)
	proto.RegisterType((*Proposal)(nil), "mezonhub.mezonhub.zvote.Proposal")
}

func init() { proto.RegisterFile("zvote/proposal.proto", fileDescriptor_a18424b8936b52ae) }
